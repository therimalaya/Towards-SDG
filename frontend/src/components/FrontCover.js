  ...
  return (
    <React.Fragment>
      <div className="cover-page">
        ...
        <p>On the next few pages you are asked to provide some basic information on the SDG-relevance of your own research. The SDG-map of NMBU, which will an output from this portal, depends on your input and your contribution. You may register as many main author contributions as you like which were published or accepted for publication in the period 2010-2019.</p>
      </div>
      <div></div>
