...
import heatmapNode  from './D3/d3-heatmap.js'
...
import { TextField, MenuItem, Button, Grid, Box, Typography } from '@material-ui/core';
...
const D3Component = (props) => {
  ...
  const draw = () => {
        ...
        d3.json('https://raw.githubusercontent.com/d3/d3-plugins/master/graph/data/miserables.json')
  ...
  return (
    <React.Fragment>
      ...
      <TextField
        ...
        value={order}
        variant="outlined">
        <MenuItem key="name" value="name">By Name</MenuItem>
        <MenuItem key="count" value="count">By Frequency</MenuItem>
        <MenuItem key="group" value="group">By Cluster</MenuItem>
      </TextField>
    </React.Fragment>
  )
}
